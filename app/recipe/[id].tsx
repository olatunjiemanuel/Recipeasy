          ...
          <View style={styles.titleContainer}>
            ...
            >
              <TouchableOpacity 
                ...
                onPress={handleLike}
              >
                <Heart size={20} color={isLiked ? Colors.error.default : Colors.text.primary} fill={isLiked ? Colors.error.default : 'transparent'} />
              </TouchableOpacity>
              <TouchableOpacity 
                style={[styles.actionButton, isSaved && styles.actionButtonActive]} 
                onPress={handleSave}
              >
                <Bookmark size={20} color={Colors.text.primary} fill={isSaved ? Colors.primary.default : 'transparent'} />
              </TouchableOpacity>
              <TouchableOpacity 
